...
public class ClonaDadosEstrutura {
	...
	public DadosEstruturaProjetoAtualizacao clonar(DadosEstruturaProjetoAtualizacao dadosOriginal) {
		...
		dadosOriginal.sub_projetos().forEach((subProj)->{
			...
			listaSub.add(new DadosEstruturaSubProjetoAtualizacao(subProj.id_sub_projeto(), subProj.nome_sub_projeto(), subProj.ordem_sub_projeto(), listaNivel));
		});
		
		DadosEstruturaProjetoAtualizacao dadoClonado = new DadosEstruturaProjetoAtualizacao(dadosOriginal.id_projeto(), dadosOriginal.ordem_projeto(), dadosOriginal.nome_projeto(), listaSub);
