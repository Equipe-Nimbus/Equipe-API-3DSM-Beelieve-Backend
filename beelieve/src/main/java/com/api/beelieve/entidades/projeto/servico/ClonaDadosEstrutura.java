...
public class ClonaDadosEstrutura {
	...
	public DadosEstruturaProjetoAtualizacao clonar(DadosEstruturaProjetoAtualizacao dadosOriginal) {
		...
		DadosEstruturaProjetoAtualizacao dadoClonado = new DadosEstruturaProjetoAtualizacao(dadosOriginal.id_projeto(), dadosOriginal.nome_projeto(), dadosOriginal.ordem_projeto(), dadosOriginal.orcamento_projeto(), dadosOriginal.hora_humano_total(), dadosOriginal.materiais_projeto(), listaSub);
